...
export default function DashboardLayout({ children, session, mainClassName }) {
  const mainCn = mainClassName ?? 'max-w-xl mx-auto px-4 py-10'
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white flex flex-col font-sans">
      ...
      <main className={`flex-1 w-full ${mainCn}`}>
        {children}
      </main>
    </div>
  )
